...
- updating WorldState based on input: spawn / remove agents, set target positions
...
- handling dynamic rendering: spawn/despawn visual agents, scale up to 500 agents efficiently
